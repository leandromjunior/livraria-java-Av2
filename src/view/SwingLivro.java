...
public class SwingLivro implements ActionListener  {
    ...
    public SwingLivro(){
        ...
        crudJ = new JLabel("Ação da CRUD em Livro:"); //Entrar com a CRUD
